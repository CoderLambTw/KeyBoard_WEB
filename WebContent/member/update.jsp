...
<link rel="shortcut icon"  href="images/logo2.png" />
  ...
  #logo{
	...
	#updateTable td, #registerTable th {
		 border: 1px solid #cbc;
		 padding: 2px 5px;
	}
	#updateTable tr:hover {background-color: #ddd;}	
	#updateTable th {
		 padding-top: 3px;
		 padding-bottom: 3px;
				...
				<thead>
					...
					<tr>
						...
						<td>
						   ...
						   value="<%= request.getParameter("id")==null?(member!=null?member.getId():""): request.getParameter("id")%>">
