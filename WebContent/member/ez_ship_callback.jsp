...
<form action="check_out.jsp" method="post" id="myForm">
    ...
    <input name="stCate" type="hidden" value="<%=stCate%>">
    <input name="stCode" type="hidden" value="<%=stCode%>">    
    <input name="stName" type="hidden" value="<%=stName%>">
    <input name="stAddr" type="hidden" value="<%=stAddr%>">
    <input name="stTel" type="hidden" value="<%=stTel%>">
    <input name="storeAddr" type="hidden" value="<%=stCode%>,<%=stName%>,<%=stAddr%>">
